...
![Version](https://img.shields.io/badge/version-1.21.3-blue.svg)
...
- The installer compares installed skill versions with `v1.21.3` and recommends updates automatically.
