# Proposta de Implantação, Serviços Gerenciados  e Hospedagem  
...
1. Provisionar uma infraestrutura que proporcione  elasticidade, sazonalidade e escala para o novo ERP, sistema de gestão fiscal e tributária e folha de pagamento;
2. Implementar o ambiente descrito em uma infraestrutura disponível e com SLA de atendimento que suporte às necessidades da TOTAL estabelecidas nesta proposta;
3. Prover meio de acesso seguro aos usuários da TOTAL;
4. Gerenciar e administrar o ambiente pró ativamente e de forma a seguir as práticas de segurança
...
# Nosso Entendimento – Solução Proposta

1. Suporte técnico e consultivo especializado para implantação de novos workloads;
2. Gestão e transformação do modelo operacional de TI como serviço;
3. Experiência e melhores práticas locais e globais;
4. DNA de consultoria da Avanade contendo grande conhecimento de mercado;
5. Serviço de nuvem confiável, segura e certificada;
6. Infraestrutura homologada e certificada para Linux e SAP;
7. Alta disponibilidade, previsão orçamentaria e pagamento sob consumo; 
8. Infraestrutura que provê elasticidade, escala e  suporte à sazonalidade;
...
# Arquitetura da Solução Desenho de Infraestrutura 
...
|        |       |                       |            | STORAGE SSD para SAP APP PROD - 256 GB                         | US           | SUSE Linux  Enterprise Edition 12 SP2 for SAP |                    | 1280                  | 512               |
| 1      | G5    | 32 vCore / 448 GB RAM | PRD        | SAP ERP DB HA + SAP ERP APP NLB - S4+HANA                      | US           | SUSE Linux  Enterprise Edition 12 SP2 for SAP |                    |                       |                   |
|        |       |                       |            | SAP HANA - File System Data (3x RAM)                           | US           | SUSE Linux  Enterprise Edition 12 SP2 for SAP |                    | 6720                  | 1536              |
|        |       |                       |            | SAP HANA -  Log (1x RAM)                                       | US           | SUSE Linux  Enterprise Edition 12 SP2 for SAP |                    | 2240                  | 512               |
|        |       |                       |            | SAP HANA -  Shared (1x RAM)                                    | US           | SUSE Linux  Enterprise Edition 12 SP2 for SAP |                    | 2240                  | 512               |
|        |       |                       |            | SAP HANA -  USR SAP e diretório root \ (binários do HANA)      | US           | SUSE Linux  Enterprise Edition 12 SP2 for SAP |                    | 2240                  | 128               |
|        |       |                       |            | STORAGE SSD para SAP APP PROD - 256 GB                         | US           | SUSE Linux  Enterprise Edition 12 SP2 for SAP |                    | 1280                  | 256               |
...
| 1      | F8    | 8 vCore / 16 GB RAM   | PRD        | Servidor DB MASTERSAF DW+ Banco de dados One Source            | US           | SUSE Linux  Enterprise Edition 12 SP2         | 300                | 1500                  |                   |
| 1      | F8    | 8 vCore / 16 GB RAM   | PRD        | Servidor One Source                                            | US           | SUSE Linux  Enterprise Edition 12 SP2         | 100                | 500                   |                   |
| 1      | D2_v2 | 2 vCore / 7 GB RAM    | PRD        | Sistema LG - FPW                                               | US           | Windows Server + SQL Std                      | 100                | 500                   |                   |
| 1      | D2_v2 | 2 vCore / 7 GB RAM    | PRD        | Sistema LG - FPW  - Web Service                                | US           | Windows Server                                | 120                | 600                   |                   |
| 1      | D2_v2 | 2 vCore / 7 GB RAM    | PRD        | Active Directory                                               | US           | Windows Server                                | 120                | 600                   |                   |

# Requisitos técnicos Infraestrutura dimensionada – Ambiente Produção
...
|        |        |                       |            | SAP HANA - File System Data (3x RAM)                                | US           | SUSE Linux  Enterprise Edition 12 SP2 for SAP |                    | 2100              | 1152              |
|        |        |                       |            | SAP HANA -  Log (1x RAM)                                            | US           | SUSE Linux  Enterprise Edition 12 SP2 for SAP |                    | 700               | 128               |
|        |        |                       |            | SAP HANA -  Shared (1x RAM)                                         | US           | SUSE Linux  Enterprise Edition 12 SP2 for SAP |                    | 700               | 128               |
|        |        |                       |            | SAP HANA -  USR SAP e diretório root \ (binários do HANA)           | US           | SUSE Linux  Enterprise Edition 12 SP2 for SAP |                    | 1400              | 256               |
|        |        |                       |            | STORAGE SSD para SAP APP PROD - 256 GB                              | US           | SUSE Linux  Enterprise Edition 12 SP2 for SAP |                    | 1280              | 256               |
|        |        |                       |            |                                                                     |              | SUSE Linux  Enterprise Edition 12 SP2 for SAP |                    |                   |                   |
| 1      | D14_v2 | 16 vCore / 112 GB RAM | QA         | SAP ERP DB - HOMOLOG / DEV + SAP ERP APP DEV - S4+HANA              | US           | SUSE Linux  Enterprise Edition 12 SP2 for SAP |                    |                   |                   |
|        |        |                       |            | SAP HANA - File System Data (3x RAM)                                | US           | SUSE Linux  Enterprise Edition 12 SP2 for SAP | 336                | 1680              |                   |
|        |        |                       |            | SAP HANA -  Log (1x RAM)                                            | US           | SUSE Linux  Enterprise Edition 12 SP2 for SAP | 112                | 560               |                   |
|        |        |                       |            | SAP HANA -  Shared (1x RAM)                                         | US           | SUSE Linux  Enterprise Edition 12 SP2 for SAP | 112                | 560               |                   |
|        |        |                       |            | SAP HANA -  USR SAP e diretório root \ (binários do HANA)           | US           | SUSE Linux  Enterprise Edition 12 SP2 for SAP | 112                | 560               |                   |
|        |        |                       |            | STORAGE SSD para SAP APP PROD - 256 GB                              | US           | SUSE Linux  Enterprise Edition 12 SP2 for SAP | 256                | 1280              |                   |
|        |        |                       |            |                                                                     |              | SUSE Linux  Enterprise Edition 12 SP2 for SAP |                    |                   |                   |
...
| 1      | F4     | 4 vCore / 8 GB RAM    | QA         | Servidor DB MASTERSAF DW+ Banco de dados One Source                 | US           | SUSE Linux  Enterprise Edition 12 SP2         | 250                |                   |                   |
| 1      | D3_v2  | 4 vCore / 14 GB RAM   | QA         | Servidor One Source                                                 | US           | SUSE Linux  Enterprise Edition 12 SP2         | 100                |                   |                   |
|        |        |                       |            |                                                                     |              |                                               |                    |                   |                   |
| 1      | D2_v2  | 2 vCore / 7 GB RAM    | QA         | Sistema LG - FPW + Oracle- DEV&QA                                   | US           | Windows Server + SQL Std                      | 100                |                   |                   |

# Requisitos técnicos Infraestrutura dimensionada – Ambiente DEV &amp; QA
...
# Infraestrutura referência para cada fase Crescimento da Infraestrutura
...
| SAP S/4 Hana | Managed Services | DEV: 16x5                                                                           | DEV & QA: 16x5                                                                        | PRD 24x7  : 24x7 DEV & QA : 24x5                                                        | PRD 24x7  : 24x7 DEV & QA : 24x5                                                                | PRD 24x7  : 24x7 DEV & QA : 24x5                                                                  |
...
| SOLMAN       | Managed Services | DEV: 16x5                                                                           | DEV: 16x5                                                                             | PRD 14X5 : 24x5                                                                         | PRD 14X5 : 24x5                                                                                 | PRD 14X5 : 24x5                                                                                   |
...
| Mastersaf    | Managed Services | DEV: 16x5                                                                           | DEV: 16x5                                                                             | PRD 24x7 : 24x7 PRD 14X5: 24x5 DEV & QA : 24x5                                          | PRD 24x7 : 24x7 PRD 10X5: 24x5 DEV & QA : 24x5                                                  | PRD 24x7 : 24x7 PRD 10X5: 24x5 DEV & QA : 24x5                                                    |
...
| LG           | Managed Services | DEV: 16x5                                                                           | DEV: 16x5                                                                             | PRD 14x5 : 24x5 (1xD2) e 8x5 (1xD2) DEV & QA : 24x5                                     | PRD 14x5 : 24x5 (1xD2) e 8x5 (1xD2) DEV & QA : 24x5                                             | PRD 14x5 : 24x5 (1xD2) e 8x5 (1xD2) DEV & QA : 24x5                                               |
| AD           | Hosting          | PRD : 24x7 1 x D2_V2                                                                | PRD : 24x7 1 x D2_V2                                                                  | PRD : 24x7 1 x D2_V2                                                                    | PRD : 24x7 1 x D2_V2                                                                            | PRD : 24x7 1 x D2_V2                                                                              |
| AD           | Managed Services | PRD: 8x5                                                                            | PRD: 8x5                                                                              | PRD: 8x5                                                                                | PRD: 8x5                                                                                        | PRD: 8x5                                                                                          |
...
# Escopo de Serviços Etapas de implantação e operação da solução 
...
# Escopo de implantação de infraestrutura
...
# Abordagem de Implantação Plano de Implantação e Operação do ambiente Azure

| Semana 1   | Semana 1   | Semana 1   | Semana 1   | Semana 1   | Semana 2   | Semana 2   | Semana 2   | Semana 2   | Semana 2   | Semana 3   | Semana 3   | Semana 3   | Semana 3   | Semana 3   | Semana 4   | Mês 2 - 12   | Ano2 - Ano5   |
|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|------------|--------------|---------------|
...
Criação de plano de arquitetura

Construção

Provisionamento de Infraestrutura DEV &amp; QA

Test

Validação da instalação de ambientes
...
# Operação – Serviços Gerenciados  Cloud Managed Services

# Escopo de Serviços Nossa proposição para serviços gerenciados de Azure para a TOTAL
...
# Abordagem da entrega da solução Modelo Operacional
...
Avanade – Architecture

(Portuguese, 8x5, Brazil DC Onshore)

Desenho de solução, Definição de Backup/Restore, Documentação
...
Avanade – CMS Operation

Português, Serviços Administrativos, Suporte 24x5 para DEV &amp; QA e 24x7 (on call em fds e feriados nacionais )

Monitoramento de Infraestrutura, Administração de Infraestrutura, Provisionamento de recursos do  Azure , Aplicação de Patches, Backup/Restore, Análise de Problemas, Reparação de Sistemas Operacionais e outros casos de nuvem
...
# Abordagem da entrega da solução Fluxo de Atendimento
...
# Dashboards Acompanhamento do nível de serviço através de dashboards
...
# Escopo do serviço Objetivos do nível de serviço (SLO)
...
| Gerenciamento da Subscrição do Azure | Administrar identidades de acesso à subscrição                                                                                                                                                                                         | A/R       |         |
| Gerenciamento da Subscrição do Azure | Abrir tickets de suporte no Azure                                                                                                                                                                                                      | A/R       | I       |
| Gerenciamento da Subscrição do Azure | Criar estruturas hierárquicas de segregação dos projetos                                                                                                                                                                               | A/R       | C       |
...
| Implantação da infraestrutura        | Configurar parâmetros dos componentes do Azure (endereços de IP, intervalos de redes, rotas, ACL, portas, tráfego de rede, grupos de afinidade e demais parâmetros dos componentes de infraestrutura de Azure utilizados pela solução) | A/R       | C/I     |
| Implantação da infraestrutura        | Instalar sistemas operacionais na fase de provisionamento                                                                                                                                                                              | A/R       |         |
| Implantação da infraestrutura        | Realizar a configuração e testes de aplicação e banco de dados                                                                                                                                                                         | C/I       | A/R     |
...
| Monitoramento                                     | Instalar agentes de monitoramento do Azure OMS                                                    | R         | A       |
| Monitoramento                                     | Monitorar componentes: processador, memória, disco e rede                                         | A/R       | I       |
| Monitoramento                                     | Definir limites (thresholds) e regras de alertas                                                  |           | A/R     |
| Monitoramento                                     | Implantar limites (thresholds) e regras de alertas                                                | R         | A       |
| Monitoramento                                     | Atuar em alertas da infraestrutura do Azure                                                       | A/R       | I       |
| Monitoramento                                     | Atuar em alertas da camada de sistema operacional e aplicações                                    | A/R       | I/C     |
| Monitoramento                                     | Atuar em alertas da camada de aplicações                                                          | I/C       | A/R     |
...
| Administração de sistema operacional e aplicações | Administrar sistemas de suporte (Active Directory e File Server)                                  |           | A/R     |
| Administração de sistema operacional e aplicações | Administrar Aplicação, binários, regras e seus componentes                                        |           | A/R     |
...
| Não faz parte do escopo dessa proposta a instalação e manutenção de qualquer software em servidores ou implantação de quaisquer ferramentas, não contempladas no escopo do projeto. É de responsabilidade da TOTAL a aquisição e instalação de qualquer software e / ou hardware necessário para este projeto.                                                                                                                                                                                                                                                                                                                  |
...
| A TOTAL deverá fornecer à Avanade o acesso ao banco de dados da ferramenta de incidentes para a Avanade prover relatórios de desempenho de SLA. Se a TOTAL não fornecer esse  acesso, deverá fornecer dados suficientes de modo que a Avanade possa medir seu desempenho diário. |
...
| É de responsabilidade da TOTAL disponibilizar profissionais com conhecimento específico nas aplicações e banco de dados para implantação e operação.                                                                                                                                                                                                                                                                                                                                   |
...
| Considerada somente uma instância produtiva para o  SAP S/4 HANA e o módulo de solução fiscal na versão 1 rodando na versão suportada de SUSE Linux                                                                                                                                                                                                                                                                                                                                    |
...
|---------------------------------------------------------|---------------------------------|---------------------------------|---------------------------------|---------------------------------|---------------------------------|
| Total anual – 70% da previsão de consumo anual do Azure | USD     43,564.77               | USD     76,251.32               | USD     72,438.76               | USD     72,438.76               | USD     72,438.76               |
...
# Por que Avanade? A Avanade é especialista em tecnologia de Nuvem Microsoft
...
# Por que Avanade? Cloud Infrastructure
...
# Certificações Azure Datacenter
