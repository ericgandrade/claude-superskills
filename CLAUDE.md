...
- **npm package**: `claude-superskills` (v1.13.8) — `npx claude-superskills`
...
### Key Architecture Principles (v1.13.8+)
...
The package version is defined in `cli-installer/package.json` (currently **v1.13.8**).
