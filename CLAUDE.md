...
- **npm package**: `claude-superskills` (v1.20.10) — `npx claude-superskills` — **46 skills**
...
The package version is defined in `cli-installer/package.json` (currently **v1.20.10**).
