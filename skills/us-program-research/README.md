...
- `SKILL.md` - End-to-end research workflow.
- `references/credential-analysis.md` - Degree equivalency and WES/ECE strategy.
- `references/scorecards.md` - Adaptive scorecards and tiering logic.
- `references/subagent-prompts.md` - Prompt templates for parallel research.
- `references/action-plan-template.md` - Final document template.
